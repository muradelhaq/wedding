...
<div x-data="{
    ...
    <div class="grid grid-cols-4 gap-2 sm:gap-4 text-center">
        ...
        <div class="bg-gradient-to-b from-white to-[#F4F7F4] border-2 border-[#D5E2D7] rounded-2xl p-3 sm:p-4 shadow-[0_4px_15px_rgba(111,149,117,0.15)] transform transition duration-300 hover:scale-105"
            ...
            <span class="text-[10px] sm:text-xs uppercase tracking-widest text-[#57795c] font-serif font-semibold">Hari</span>
        </div>
        ...
        <div class="bg-gradient-to-b from-white to-[#F4F7F4] border-2 border-[#D5E2D7] rounded-2xl p-3 sm:p-4 shadow-[0_4px_15px_rgba(111,149,117,0.15)] transform transition duration-300 hover:scale-105"
            ...
            <span class="text-[10px] sm:text-xs uppercase tracking-widest text-[#57795c] font-serif font-semibold">Jam</span>
        </div>
        ...
        <div class="bg-gradient-to-b from-white to-[#F4F7F4] border-2 border-[#D5E2D7] rounded-2xl p-3 sm:p-4 shadow-[0_4px_15px_rgba(111,149,117,0.15)] transform transition duration-300 hover:scale-105"
            ...
            <span class="text-[10px] sm:text-xs uppercase tracking-widest text-[#57795c] font-serif font-semibold">Menit</span>
        </div>
        ...
        <div class="bg-gradient-to-b from-white to-[#F4F7F4] border-2 border-[#D5E2D7] rounded-2xl p-3 sm:p-4 shadow-[0_4px_15px_rgba(111,149,117,0.15)] transform transition duration-300 hover:scale-105"
            ...
            <span class="text-[10px] sm:text-xs uppercase tracking-widest text-[#57795c] font-serif font-semibold">Detik</span>
        </div>
    </div>
</div>
