...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'groom_origin', 'value' => 'Istanbul, Turki', 'group' => 'couple', 'type' => 'text'],
            ['key' => 'groom_photo', 'value' => '/images/cartoon_groom.webp', 'group' => 'couple', 'type' => 'image'],
            ['key' => 'groom_instagram', 'value' => 'Ramazanakcaalan._', 'group' => 'couple', 'type' => 'text'],
            ...
            ['key' => 'bride_instagram', 'value' => 'Hayira_Bohs', 'group' => 'couple', 'type' => 'text'],

            // Event Details (Akad & Walimah)
            ['key' => 'event_title', 'value' => 'Rangkaian Acara Pernikahan', 'group' => 'event', 'type' => 'text'],
            ...
            ['key' => 'akad_title', 'value' => 'Akad Nikah', 'group' => 'event', 'type' => 'text'],
            ['key' => 'akad_time', 'value' => '10.00 - 11.00 WIB', 'group' => 'event', 'type' => 'text'],
            ['key' => 'walimah_title', 'value' => 'Walimatul \'Urs', 'group' => 'event', 'type' => 'text'],
            ['key' => 'walimah_time', 'value' => '11.00 - 15.00 WIB', 'group' => 'event', 'type' => 'text'],
            ['key' => 'event_venue', 'value' => 'Rumah Makan Leila', 'group' => 'event', 'type' => 'text'],
            ['key' => 'event_address', 'value' => 'Jl. Raya Garut – Cikajang No. 22, Mekarsari, Kec. Cikajang, Kabupaten Garut, Jawa Barat 44171', 'group' => 'event', 'type' => 'textarea'],
            ['key' => 'event_maps_url', 'value' => 'https://share.google/yFV64kCwHfucu2xOl', 'group' => 'event', 'type' => 'text'],
            ['key' => 'event_maps_embed', 'value' => 'https://www.google.com/maps?q=Rumah+Makan+Leila+Cikajang+Garut&output=embed', 'group' => 'event', 'type' => 'textarea'],
        ];
